    ...
    <div>
        <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-small'>
            <div>
                ...
                <p className='w-full md:w-2/3 text-gray-600'> Your destination for premium fashion — curated styles for men, women, and kids. Quality you can feel, prices you'll love.</p>
            </div>
            <div>
