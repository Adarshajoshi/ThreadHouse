  ...
  return (
    <div className='lg:px-20 '>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-stone-600 '>
          ...
          <b className='text-stone-800 '>Our Mission</b>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-4'>
          ...
          <p className='text-stone-600 '>We ensure every piece meets high standards of quality, comfort, and durability before it reaches you.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-4'>
          <b>Convenience</b>
          <p className='text-stone-600 '>With our user-friendly interface and hassle-free ordering process,shopping has never been easier.</p>
        </div>
        <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-4'>
          <b>Exceptional Customer Service</b>
          <p className='text-stone-600 '>Our team of dedicated professionals is here to assist you the way, ensuring your satisfaction is our top priority.</p>
        </div>
      </div>
      <NewsletterBox/>
    </div>
