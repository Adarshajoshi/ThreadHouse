...
const PrivacyPolicy = () => {
  return (
    <div className='lg:px-20 border-t'>
      ...
      <p className='text-xs text-stone-400 text-center mb-10'>Last updated: March 2025</p>

      <div className='flex flex-col gap-8 text-stone-600 text-sm leading-relaxed mb-20 max-w-3xl mx-auto'>

        <section>
          <h2 className='text-base font-semibold text-stone-800 mb-2'>1. Information We Collect</h2>
        ...
        <section>
          <h2 className='text-base font-semibold text-stone-800 mb-2'>2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className='text-base font-semibold text-stone-800 mb-2'>3. Data Security</h2>
        ...
        <section>
          <h2 className='text-base font-semibold text-stone-800 mb-2'>4. Cookies</h2>
        ...
        <section>
          <h2 className='text-base font-semibold text-stone-800 mb-2'>5. Third-Party Services</h2>
          <p>Currently we accept Cash on Delivery only. Any future third-party payment processors will be listed here with their own privacy policies.</p>
        </section>

        <section>
          <h2 className='text-base font-semibold text-stone-800 mb-2'>6. Your Rights</h2>
        ...
        <section>
          <h2 className='text-base font-semibold text-stone-800 mb-2'>7. Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, please contact us at:<br />
            <span className='font-medium text-stone-800 '>support@threadhouse.com</span><br />
