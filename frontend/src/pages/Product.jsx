...
const Product = () => {
  ...
  // RFM tracking: log a product_view as soon as we know the product's price
  useEffect(() => {
    if (productData) {
      trackProductView(productData._id, productData.price)
    }
  }, [productData?._id])
  ...
  return productData ? (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        {/*Product Images */}
        <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row pl-4'>
          <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden justify-between sm:justify-normal sm:w-[18.7%] w-full'>
            {
